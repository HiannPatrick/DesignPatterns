using Prototype_Exemplo1.Models;

using System;

namespace Prototype_Exemplo1
{
	class Program
	{
		static void Main( string[] args )
		{
			...
			var settingsPrototypeRegistry = new ProfileSettingsPrototypeRegistry( defaultSettingsPrototype,
																				  secureSettingsPrototype);
